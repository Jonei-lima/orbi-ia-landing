...
export async function POST(req: Request) {
  try {
    ...
    // ⚠️ AINDA NÃO REMOVIDO — aguardando o arquivo do frontend da Clínicas
    // pra trocar isso pelo padrão fixo (mesmo WhatsApp/botão do ADV e Contador)
    // sem quebrar o que já está no ar.
    // =====================
